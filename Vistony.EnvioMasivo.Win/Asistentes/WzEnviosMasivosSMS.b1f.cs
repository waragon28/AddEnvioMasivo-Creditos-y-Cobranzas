...
{
    [FormAttribute("vis_EnvioMasivoCRE", "Asistentes/WzEnviosMasivosSMS.b1f")]
    class WzEnviosMasivosSMS : UserFormBase
    {
        ...
        private void NextPane()
        {
            ...
            {
                oForm.PaneLevel = 5;
                if (EditText8.Value=="" || EditText9.Value=="")
                {
                    Sb1Messages.ShowError("Se requiere que se ingrese una compañia y un mensaje a enviar");
                }
                else if (Grid1.Rows.Count==0)
                {
                    Sb1Messages.ShowError("Se requiere como minimo 1 Cliente seleccionado");
                }
                else
                {
                    var Message = Sb1Messages.ShowMessageBox("Se generara la siguiente campaña " + EditText8.Value + "\n" + "¿Desea Continuar?");
                    if (Message == 2 || Message == 3)
                    {
                        oForm.PaneLevel = 5;
                    }
        ...
        private void mythread_POST_SMS_CREDITOS()
        {
            Console.WriteLine("In progress thread is: {0}", Thread.CurrentThread.Name);
            CargarCodUsuario();
          
            RespuestMensaje = EditText2.Value;
            if (CodUsuario != "" && CodAsignacion != "" && CodUsuario!=null && CodAsignacion != null)
            {
                Sb1Messages.ShowWarning("Ejecutando envio de mensaje");
                tr.EnviarSMSCREDITOS(EditText2, Grid1, EditText9);
                if (EditText2.Value == "OK")
                {
                    Sb1Messages.ShowWarning("Generando Campaña " + "");
                    // CargarCodUsuario();
                    if (CodUsuario != "" && CodAsignacion != "")
                    {
                        EditText2.Value = "";
                        Sb1Messages.ShowWarning("Validando Campaña " + "");
                        tr.GenerarCampania(Grid1, EditText8, EditText9, CodUsuario, CodAsignacion, EditText2, StaticText10, EditText10);
                        if (EditText2.Value == "CREADO")
                        {
                            Sb1Messages.ShowSuccess("Se Envio Correctamente el mensaje");
                            oForm.PaneLevel = 6;
                    ...
                    {
                        Sb1Messages.ShowError("Validar configuracion del usuario " + usuario);
                    }
        ...
        public void update_POST_SMS_CREDITOS()
        {
            // Creating and initializing thread
            Thread mythr = new Thread(mythread_POST_SMS_CREDITOS);
        ...
        public override void OnInitializeComponent()
        {
            ...
            this.OptionBtn1 = ((SAPbouiCOM.OptionBtn)(this.GetItem("Item_19").Specific));
            ...
            this.EditText5 = ((SAPbouiCOM.EditText)(this.GetItem("Item_35").Specific));
            this.StaticText22 = ((SAPbouiCOM.StaticText)(this.GetItem("Item_37").Specific));
            this.StaticText23 = ((SAPbouiCOM.StaticText)(this.GetItem("Item_38").Specific));
            this.StaticText24 = ((SAPbouiCOM.StaticText)(this.GetItem("Item_39").Specific));
            this.EditText6 = ((SAPbouiCOM.EditText)(this.GetItem("Item_40").Specific));
            ...
            this.Button3 = ((SAPbouiCOM.Button)(this.GetItem("Item_42").Specific));
            ...
            this.EditText7 = ((SAPbouiCOM.EditText)(this.GetItem("Item_43").Specific));
            this.EditText8 = ((SAPbouiCOM.EditText)(this.GetItem("Item_44").Specific));
            this.StaticText25 = ((SAPbouiCOM.StaticText)(this.GetItem("Item_45").Specific));
            this.EditText9 = ((SAPbouiCOM.EditText)(this.GetItem("Item_46").Specific));
            this.StaticText26 = ((SAPbouiCOM.StaticText)(this.GetItem("Item_47").Specific));
            this.StaticText27 = ((SAPbouiCOM.StaticText)(this.GetItem("Item_48").Specific));
            this.LinkedButton1 = ((SAPbouiCOM.LinkedButton)(this.GetItem("Item_49").Specific));
            this.EditText10 = ((SAPbouiCOM.EditText)(this.GetItem("Item_50").Specific));
            this.EditText11 = ((SAPbouiCOM.EditText)(this.GetItem("Item_51").Specific));
        ...
        private void OnCustomInitialize()
        {
            ...
            GetText(Sb1Globals.Idioma);
        }
        private void GetText(string idioma)
        {
            if (idioma== "English (United States)")
            {
                StaticText6.Caption = Idioma_Ingles.Asistente_de_Envíos_Masivos;
            }
        ...
        {
            tr.Get_Cliente_ClienteesCredito(oDatatable, Grid1, oForm, EditText3.Value, EditText5.Value, EditText7.Value);
        }
        ...
        private void EditText6_ChooseFromListAfter(object sboObject, SAPbouiCOM.SBOItemEventArg pVal)
        {
            ...
            try
            {
                ...
                if (chooseFromListEvent.SelectedObjects != null)
                {
                    ...
                    {
                        EditText6.Value = chooseFromListEvent.SelectedObjects.GetValue("OcrCode", 0).ToString();
                        EditText7.Value = chooseFromListEvent.SelectedObjects.GetValue("OcrName", 0).ToString();
                    }
                }
